...
const productExtras = {
  ...
  'plataforma-ferias': {
    image: '/ferias-hero.png',
    problem: 'Las ferias y exposiciones tradicionales pierden oportunidades de negocio por falta de tecnología: no hay datos de visitantes, los expositores pierden leads y la organización no tiene métricas claras.',
    benefits: [
      'Credenciales digitales con QR para visitantes — imagen moderna y profesional',
      'Los expositores capturan y clasifican leads directamente desde su móvil',
      'Mapa interactivo del recinto con ubicación de cada stand',
      'La organización tiene control total: visitantes, leads y estadísticas',
      'Cumplimiento LOPDP con consentimiento explícito de datos'
    ],
    target: 'Organizadores de ferias, exposiciones, congresos y eventos empresariales que quieran ofrecer una experiencia moderna a visitantes y expositores.',
    externalLink: 'https://proyecto-ferias2026.vercel.app/',
    faqs: [
      { q: '¿Necesito instalar algo especial?', a: 'La plataforma es una Progressive Web App (PWA) que se instala directamente desde el navegador del móvil, sin pasar por tiendas de apps.' },
      { q: '¿Cómo funciona el QR del visitante?', a: 'Al registrarse, cada visitante recibe una credencial digital con su QR único. Los expositores escanean ese QR para registrar el lead automáticamente.' },
      { q: '¿Se pueden exportar los leads?', a: 'Sí, cada expositor puede exportar sus leads a Excel o CSV en cualquier momento.' },
      { q: '¿Funciona para ferias de cualquier tamaño?', a: 'Sí, la plataforma está diseñada para ferias pequeñas y medianas. Para eventos muy grandes, podemos hacer una propuesta personalizada.' },
    ]
  },
};
