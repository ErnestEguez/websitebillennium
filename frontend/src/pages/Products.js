...
const products = [
  ...
  },
  {
    ...
    tagline: 'Ferias más inteligentes, expositores más exitosos',
    description: 'App móvil instalable + panel web de administración para gestionar ferias de forma profesional. Credenciales QR, mapa interactivo, captación de leads y reportes.',
    icon: Ticket,
    image: '/ferias-hero.png',
    features: ['Credencial digital con código QR', 'Mapa del recinto con stands', 'Catálogo de expositores con búsqueda', 'Captura de leads con clasificación', 'Notificaciones generales a visitantes', 'Exportación de leads a Excel/CSV'],
