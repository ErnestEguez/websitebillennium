...
export function LoginPage() {
    ...
    // Si viene del portal con magic link, AuthContext lo procesa — solo esperamos
    const hasMagicLink =
    ...
    // Pantalla de espera mientras procesa el magic link del portal
    if (hasMagicLink && authLoading) {
        return (
            <div className="min-h-screen bg-slate-50 flex items-center justify-center">
                <div className="text-center">
                    <div className="w-16 h-16 bg-primary-600 rounded-2xl flex items-center justify-center text-white text-3xl font-bold mx-auto mb-4 animate-pulse">R</div>
                    <p className="text-slate-500">Iniciando sesión desde el portal...</p>
                </div>
            </div>
        )
    }
