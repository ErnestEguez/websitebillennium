...
-- 2. HELPER FUNCTION (SECURITY DEFINER + SET SEARCH_PATH)
-- This is the most robust way to check roles during RLS without cycles
...
-- Note: We use is_platform_admin() first to avoid unnecessary subqueries
