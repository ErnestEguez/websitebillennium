...
const CONCEPTOS_ESTANDAR: Omit<ConceptoNomina, 'id' | 'empresa_id' | 'created_at' | 'updated_at'>[] = [
    ...
    { codigo: 'HRS_NOCT_25',         nombre: 'Horas Nocturnas (25% recargo)',        tipo: 'ingreso',   formula: 'porcentaje_sueldo',  valor_predeterminado: 25,   afecta_iess: true,  afecta_renta: true,  es_legal: false, aplica_siempre: false, orden: 12, activo: true },
